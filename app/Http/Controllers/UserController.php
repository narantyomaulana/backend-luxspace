        ...
        {   
            ...
            return DataTables::of($query)
                ->addColumn('action', function($item){ // untuk edit
                    return '
                        <a href="'. route('dashboard.user.edit', $item->id) .'" class="inline-block border border-gray-500 bg-gray-500 text-white rounded-md px-2 py-1 m-1 transition duration-500 ease select-none hover:bg-gray-800 focus:outline-none focus:shadow-outline">
                            Edit
                        </a>
